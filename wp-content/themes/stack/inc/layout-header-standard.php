...
<?php
if ( is_front_page() ) {
    echo "<div class='nav-container' style='background-color: #fff;'>";
} else {
...
?>
    ...
    <div
            class="bar bar--sm visible-xs <?php echo esc_attr( $background ); ?> <?php echo esc_attr( $mobile_scroll_class ); ?>"
            <?php echo wp_kses_post( $mobile_scroll ); ?>
    >
        <div class="container">
            <div class="row">
    ...
    <nav id="menu1"
         class="bar bar--sm bar-1 hidden-xs hiddem-sm  <?php echo esc_attr( $background ); ?>" <?php echo wp_kses_post( $scroll ); ?>>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-11 col-sm-12 text-right text-left-xs text-left-sm pc-main-menu">
					<?php get_template_part( 'inc/content-header', 'nav' ); ?>
					<?php get_template_part( 'inc/content-header', 'buttons' ); ?>
                </div>
                <div class="col-md-8 col-sm-8 text-right text-left-xs text-left-sm tablet-main-menu">
		            <?php get_template_part( 'inc/content-header', 'nav' ); ?>
		            <?php get_template_part( 'inc/content-header', 'buttons' ); ?>
                </div>
