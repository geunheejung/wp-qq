<div id="kboard-avatar-list">
    ...
    <div class="kboard-list">
        <table>
            ...
            <tr>
                ...
                <!--                 <td class="kboard-list-title" colspan="6"><?php echo __('Title', 'kboard') ?></td> -->
            ...
            <?php while ($content = $list->hasNextNotice()): ?>
                <tr class="kboard-list-notice<?php if ($content->uid == kboard_uid()): ?> kboard-list-selected<?php endif ?>'">
                    ...
                    <td class="kboard-list-title" colspan="6" id="list-title__toggle">
                        <a href="#">
                            <div class="kboard-avatar-cut-strings">
                                ...
                                <?php if ($content->secret): ?><img
                                    src="<?php echo $skin_path ?>/images/icon-lock.png"
                        ...
                        <div id="list-content__toggle" class="kboard-list__content hide"
                             itemprop="description">
                            <p class="kboard-content-description">
    ...
    <?php if ($board->isWriter()): ?>
        <!-- 버튼 시작 -->
        <div class="kboard-control">
            <a href="<?php echo $url->getContentEditor() ?>"
